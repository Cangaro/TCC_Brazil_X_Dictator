...
//verificardo
    ...
    void Update()
    {
        if (Satisfazer)
        {
            if (Player.IsPlayng)
            {
                if (_animator.GetCurrentAnimatorStateInfo(0).IsName("FanIddle4"))
                {
                    _animator.Play("FanDancing4");
                }
            ...
            {
                if (_animator.GetCurrentAnimatorStateInfo(0).IsName("FanDancing4"))
                {
                    _animator.Play("FanIddle4");
                }
            }
        }
    }
